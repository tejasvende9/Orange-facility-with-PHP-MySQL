...
$qS="SELECT * FROM  business_owner WHERE oem='$email' AND opwd='$pass'";
...
<head>
    ...
    <title>Orange Facility | Service Provider Login </title>
                    ...
                    <form action="index.php" method="post">
                       <label>Email </label>
                        ...
                        <div class="text-center mt-3">
                            ...
                            <a href="register-provider.php"
                                class="text-decoration-none text-primary">Create An Account? ?</a>
